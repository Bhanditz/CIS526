...
java -mx4g -DJACANA_HOME=../ -jar ../build/lib/jacana-align.jar -r $data_dir/train/train.json -d $data_dir/dev/dev.json -t $data_dir/test/test.json -m ./es-en-align.model
